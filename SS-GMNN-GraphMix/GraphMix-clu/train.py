...
def train(epoches):
    ...
    for epoch in range(epoches):
        ...
        if rand_index == 0:
            ...
            loss , loss_usup, loss0 = trainer.update_soft_aux(inputs_q, target_q, target, idx_train, idx_unlabeled_subset, adj,  opt, mixup_layer =[1], idx_u=idx_unlabel)
            ...
            trainer.model.train()
            trainer.optimizer.zero_grad()
            loss, loss0 = trainer.update_soft(inputs_q, target_q, idx_train, idx_u=idx_unlabel)
